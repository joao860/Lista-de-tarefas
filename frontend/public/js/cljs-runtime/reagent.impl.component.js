...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21834 = c;
var G__21834__$1 = (((G__21834 == null))?null:G__21834.prototype);
if((G__21834__$1 == null)){
return null;
} else {
return G__21834__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21835 = c;
var G__21835__$1 = (((G__21835 == null))?null:G__21835.prototype);
if((G__21835__$1 == null)){
return null;
} else {
return G__21835__$1.render;
}
})() == null)))));
});
...
var or__5025__auto__ = (function (){var G__21845 = c;
var G__21845__$1 = (((G__21845 == null))?null:G__21845.constructor);
if((G__21845__$1 == null)){
return null;
} else {
return G__21845__$1.displayName;
}
})();
...
var G__21846 = c;
var G__21846__$1 = (((G__21846 == null))?null:G__21846.constructor);
if((G__21846__$1 == null)){
return null;
} else {
return G__21846__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21847 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21848 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21848);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21847);
}});
...
var c = this;
var G__21887_21941 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21887_21941 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21887_21941);
}
...
var renders_21942 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21943 = cljs.core.first(cljs.core.vals(renders_21942));
...
if((cljs.core.count(renders_21942) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21942))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21943)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21943], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21922 = o;
reagent.impl.component.goog$module$goog$object.set(G__21922,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21923 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21924 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21924);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21923);
}});
...
var vec__21925 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21925,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21925,(1),null);
...
var G__21928 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21928 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21928);
}
});
}),[]);
