...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17930 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17930(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_17931 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_17931(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_17935 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_17935(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_17936 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_17936(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17939 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17939(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17941 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17941(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__17928,callback){
var map__17929 = p__17928;
var map__17929__$1 = cljs.core.__destructure_map(map__17929);
var input = map__17929__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17929__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17929__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
