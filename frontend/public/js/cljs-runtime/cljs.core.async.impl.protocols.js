...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11903 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11903(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11905 = (function (port,val,fn1_handler){
var x__5373__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11905(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11907 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11907(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11914 = (function (chan){
var x__5373__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11914(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11921 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11921(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_11933 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_11933(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_11934 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_11934(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11943 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11943(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11945 = (function (b){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11945(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11955 = (function (b,itm){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11955(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11969 = (function (b){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11969(b);
}
});
