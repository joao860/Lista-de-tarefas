...
var G__21956 = o;
reagent.impl.template.goog$module$goog$object.set(G__21956,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__21963 = o;
reagent.impl.template.goog$module$goog$object.set(G__21963,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22013__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22014__i < G__22014__a.length) {G__22014__a[G__22014__i] = arguments[G__22014__i + 0]; ++G__22014__i;}
  args = new cljs.core.IndexedSeq(G__22014__a,0,null);
} 
return G__22013__delegate.call(this,args);};
G__22013.cljs$lang$maxFixedArity = 0;
G__22013.cljs$lang$applyTo = (function (arglist__22015){
var args = cljs.core.seq(arglist__22015);
return G__22013__delegate(args);
});
...
var G__21964 = props;
var G__21964__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21964,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21964);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21964__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21965 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21965,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21965;
}
})(),id_class);
...
var G__21966 = (cljs.core.count(argv) - first_child);
switch (G__21966) {
case (0):
...
var vec__21971 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21971,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21971,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21971,(2),null);
...
var temp__5827__auto___22032 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___22032 == null)){
} else {
var key_22033 = temp__5827__auto___22032;
(jsprops.key = key_22033);
}
...
var temp__5827__auto___22035 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___22035 == null)){
} else {
var key_22040 = temp__5827__auto___22035;
(jsprops.key = key_22040);
}
...
var temp__5827__auto___22043 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5827__auto___22049 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___22049 == null)){
} else {
var key_22050 = temp__5827__auto___22049;
(jsprops.key = key_22050);
}
...
var temp__5827__auto___22051 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___22051 == null)){
} else {
var key_22052 = temp__5827__auto___22051;
(jsprops.key = key_22052);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21979_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21979_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21986 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21986,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21986,(1),null);
...
break;
default:
var G__22056 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22057 = compiler;
v = G__22056;
compiler = G__22057;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template21999 = (function (opts,id,fn_to_element,parse_fn,meta22000){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21999.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22001,meta22000__$1){
var self__ = this;
var _22001__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21999(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22000__$1));
}));

(reagent.impl.template.t_reagent$impl$template21999.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22001){
var self__ = this;
var _22001__$1 = this;
return self__.meta22000;
}));

(reagent.impl.template.t_reagent$impl$template21999.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21999.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21999.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21999.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21999.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21999.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22000","meta22000",-1231840061,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21999.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21999.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21999");

(reagent.impl.template.t_reagent$impl$template21999.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template21999");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21999.
 */
reagent.impl.template.__GT_t_reagent$impl$template21999 = (function reagent$impl$template$__GT_t_reagent$impl$template21999(opts,id,fn_to_element,parse_fn,meta22000){
return (new reagent.impl.template.t_reagent$impl$template21999(opts,id,fn_to_element,parse_fn,meta22000));
});
...
return (new reagent.impl.template.t_reagent$impl$template21999(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
