...
var i_12391 = (0);
while(true){
if((i_12391 < arr.length)){
(arr[i_12391] = null);

var G__12392 = (i_12391 + (1));
i_12391 = G__12392;
continue;
} else {
}
...
var i_12408 = (self__.level + (1));
while(true){
if((i_12408 <= (new_level + (1)))){
(update[i_12408] = self__.header);

var G__12413 = (i_12408 + (1));
i_12408 = G__12413;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_12416 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12416[i]));
} else {
x__$2.forward.push((((i < links_12416.length))?(links_12416[i]):null));
}

if((i < links_12416.length)){
(links_12416[i] = x__$2);
} else {
links_12416.push(x__$2);
}
...
var i_12440 = (0);
while(true){
if((i_12440 <= self__.level)){
var links_12445 = (update[i_12440]).forward;
if((x__$1 === (((i_12440 < links_12445.length))?(links_12445[i_12440]):null))){
(links_12445[i_12440] = (x__$1.forward[i_12440]));

var G__12455 = (i_12440 + (1));
i_12440 = G__12455;
continue;
} else {
var G__12457 = (i_12440 + (1));
i_12440 = G__12457;
continue;
}
} else {
...
var G__12499 = nx;
var G__12500 = (level__$1 - (1));
x = G__12499;
level__$1 = G__12500;
continue;
} else {
var G__12505 = x;
var G__12506 = (level__$1 - (1));
x = G__12505;
level__$1 = G__12506;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__12532 = nx;
var G__12533 = (level__$1 - (1));
x = G__12532;
level__$1 = G__12533;
continue;
} else {
var G__12534 = x;
var G__12535 = (level__$1 - (1));
x = G__12534;
level__$1 = G__12535;
continue;
}
